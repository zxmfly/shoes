...
return [
    ...
    10 => ['title'=>'员工中心', 'name'=>'我的任务', 'icon'=>'layui-icon-caidan','url'=>'task/index?action=myTask', 'class'=>'seraph', 'title_icon'=>'layui-icon-friends'],
    11 => ['title'=>'员工中心', 'name'=>'员工列表', 'icon'=>'icon-ziliao','url'=>'worker/info', 'class'=>'seraph'],
    12 => ['title'=>'员工中心', 'name'=>'员工列表', 'icon'=>'layui-icon-xiugai','url'=>'worker/password', 'class'=>'seraph'],
    ...
    34 => ['title'=>'系统日志', 'name'=>'参数配置', 'icon'=>'icon-log','url'=>'log','class'=>'seraph'],
];